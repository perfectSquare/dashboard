...
<script setup>
	...
	async function accessoriesFetch(){
		...
		await axios.get('https://my-fake-json.herokuapp.com/accessories')
		.then((res) =>{ 
...
////////////////////////////////////////////////////////////////////////////////////////////
	...
	async function laptopsFetch(){
		...
		await axios.get('https://my-fake-json.herokuapp.com/laptops')
		.then((res) =>{ 			
...
//////////////////////////////monitors
	async function monitorsFetch(){
		...
		await axios.get('https://my-fake-json.herokuapp.com/monitors')
		.then((res) =>{ 			
...
//////////////////////////////storage
	async function storageFetch(){
		...
		await axios.get('https://my-fake-json.herokuapp.com/storage')
		.then((res) =>{ 			
...
////////////////////////////////////////////////////////////////////////////////////////
	...
	const updateProduct = async () => {
		await axios.patch('https://my-fake-json.herokuapp.com/accessories/1', {price:700})
		.then((res) => {
