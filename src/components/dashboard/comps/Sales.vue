...
<script setup>
	...
	async function getSaleAtDate(){
		...
		await axios.get('https://my-fake-json.herokuapp.com/sales', {params:{ date:atDay.value }})
		.then((res) => {saleAtDate.value = res.data; atDayLoading.value = false;})
		.catch((err) => console.log(err))

		await axios.get('https://my-fake-json.herokuapp.com/sold', {params:{ date:atDay.value }})
...
/////////////////////////////////////////////////////////////////////////////////////////////
	...
	const weekFetch = async (start, limit) => {
		...
		await axios({
			baseURL: 'https://my-fake-json.herokuapp.com/sales',
			method: 'get',
			params: {				
				_start: start,
				_limit: limit
