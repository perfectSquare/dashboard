...
<script setup>
	...
	const getSoldFromTo = async () => {
		...
		let limit = 0
		await axios.all([
  			axios.get('https://my-fake-json.herokuapp.com/sold', {params:{date: fromDate.value }}), 
  			axios.get('https://my-fake-json.herokuapp.com/sold', {params:{date: toDate.value }})
		])
		.then(axios.spread((data1, data2) => {
  		...
  		///////////////////// now final request
		axios.get('https://my-fake-json.herokuapp.com/sold', {params:{ _start:start, _limit:limit }})
		.then((res) => {
        	...
        	m=0;
				...
				axios({
					baseURL: 'https://my-fake-json.herokuapp.com/',
					method: 'get',
					url: finalType,
